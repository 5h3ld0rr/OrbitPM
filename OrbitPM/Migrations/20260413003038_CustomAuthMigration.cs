...
{
    /// <inheritdoc />
    public partial class CustomAuthMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SupervisorResearchAreas_Users_SupervisorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MatchRecords_Users_SupervisorId",
                        column: x => x.SupervisorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProposalOwnerships", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProposalOwnerships_ProjectProposals_ProjectProposalId",
                        column: x => x.ProjectProposalId,
                        principalTable: "ProjectProposals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProposalOwnerships_Users_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProposalOwnerships_ProjectProposalId",
                table: "ProposalOwnerships",
                column: "ProjectProposalId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProposalOwnerships_StudentId",
                table: "ProposalOwnerships",
                column: "StudentId");
